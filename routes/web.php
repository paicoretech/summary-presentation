...
//    Route::get('/', function () {           return view('dashboard.homepage'); });
    Route::get('/', 'HomeController@integrated');
    Route::get('/home', 'HomeController@integrated')->name('Dashboard');

    Route::group(['middleware' => ['role:user']], function () {
        Route::get('/charts', 'GrafanaController@getPublicDashboardsView')->name('dashboard.charts');
        Route::get('/location', function () {     return view('dashboard.location'); });
        Route::get('/integrated', function () {     return view('dashboard.integrated-diagram'); });
        Route::get('/download', 'DownloadController@index')->name('dashboard.download');
        Route::get('/dwr-monitor', 'DwrMonitorController@index')->name('dashboard.dwr-monitor');
        Route::post('/dwr-monitor/fetch', 'DwrMonitorController@fetch')->name('dwr-monitor.fetch');
        Route::get('/downloads/list', [DownloadController::class, 'fetchJobs'])->name('downloads.list');
        Route::post('/downloads/{jobId}/cancel', [DownloadController::class, 'cancel'])->name('downloads.cancel');
        Route::post('/downloads/{jobId}/clear', [DownloadController::class, 'clearJob'])->name('downloads.clear');
        Route::get('/colors', function () {     return view('dashboard.colors'); });
        Route::get('/typography', function () { return view('dashboard.typography'); });
        Route::get('/charts2', function () {     return view('dashboard.charts2'); });
        ...
        Route::prefix('invoice')->group(function () {
            Route::get('/invoice', function(){   return view('dashboard.invoice.invoice'); });
            Route::get('/invoice2', function(){   return view('dashboard.invoice.invoice2'); });
            Route::get('/badge', function(){    return view('dashboard.notifications.badge'); });
            Route::get('/modals', function(){   return view('dashboard.notifications.modals'); });
        });
        Route::prefix('customer')->group(function () {
            Route::get('/customer', function(){   return view('dashboard.customer.customer'); });
        });
