...
class MenusTableSeeder extends Seeder
{
    ...
    */
    ...
    { 
        ...
        $this->insertLink('guest,user,admin', 'Subscribers', '/home', 'cil-search');
        $this->insertLink('guest,user,admin', 'Location', '/location', 'cil-location-pin');
        $this->insertLink('guest,user,admin', 'Statistics', '/charts', 'cil-chart');
        ...
        */
        ...
        //$this->insertLink('guest,user,admin', 'Facturas', '/invoice/invoice2');
        //$this->insertLink('guest,user,admin', 'Clientes', '/customer/customer');
        ...
        $this->menuId = DB::getPdo()->lastInsertId();  //set menuId
        $id = $this->insertLink('guest,user,admin', 'navigation',    '/');
        /*
