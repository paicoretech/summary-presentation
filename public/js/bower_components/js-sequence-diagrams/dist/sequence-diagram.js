...
if (typeof Snap != 'undefined') {
  ...
  _.extend(SnapTheme.prototype, BaseTheme.prototype, {
    ...
    drawSignal: function(signal, offsetY) {
      this.beginGroup();
      if(container_global == ''){
        container_global = this.diagram.title;
      }
      else if(container_global != this.diagram.title){
        container_global = this.diagram.title;
        cont = 0;
      }
      BaseTheme.prototype.drawSignal.call(this, signal, offsetY);
      cont = cont + 1;
      return this.finishGroup().addClass('signal').attr('cont',cont).attr("style","cursor:pointer;");
    },
